...
/**
 * Model tests for CreateLoanSuccess
 */
public class CreateLoanSuccessTest {
    private final CreateLoanSuccess model = new CreateLoanSuccess();
