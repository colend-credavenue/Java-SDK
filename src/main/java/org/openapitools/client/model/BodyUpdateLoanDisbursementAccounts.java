...
public class BodyUpdateLoanDisbursementAccounts {
  ...
  public BodyUpdateLoanDisbursementAccounts id(String id) {
   ...
   /**
   * ID as provided in Get Loan Details API
   * @return id
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID as provided in Get Loan Details API")
  ...
  public BodyUpdateLoanDisbursementAccounts accountType(String accountType) {
   ...
   /**
   * Borrower/Existing Lender
   * @return accountType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Borrower/Existing Lender")
  ...
  public BodyUpdateLoanDisbursementAccounts bankName(String bankName) {
  ...
  **/
  ...
  public BodyUpdateLoanDisbursementAccounts bankAccountType(String bankAccountType) {
  ...
  **/
  ...
  public BodyUpdateLoanDisbursementAccounts accountName(String accountName) {
  ...
  **/
  ...
  public BodyUpdateLoanDisbursementAccounts bankBranchName(String bankBranchName) {
  ...
  **/
  ...
  public BodyUpdateLoanDisbursementAccounts ifscCode(String ifscCode) {
  ...
  **/
  ...
  public BodyUpdateLoanDisbursementAccounts entityType(String entityType) {
   ...
   /**
   * Dealer / Sub-Dealer / Originator / Existing Lender / End Customer
   * @return entityType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Dealer / Sub-Dealer / Originator / Existing Lender / End Customer")
  ...
  public BodyUpdateLoanDisbursementAccounts accountNo(String accountNo) {
  ...
  **/
  ...
  public BodyUpdateLoanDisbursementAccounts amount(Float amount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BodyUpdateLoanDisbursementAccounts bodyUpdateLoanDisbursementAccounts = (BodyUpdateLoanDisbursementAccounts) o;
    return Objects.equals(this.id, bodyUpdateLoanDisbursementAccounts.id) &&
        Objects.equals(this.accountType, bodyUpdateLoanDisbursementAccounts.accountType) &&
        Objects.equals(this.bankName, bodyUpdateLoanDisbursementAccounts.bankName) &&
        Objects.equals(this.bankAccountType, bodyUpdateLoanDisbursementAccounts.bankAccountType) &&
        Objects.equals(this.accountName, bodyUpdateLoanDisbursementAccounts.accountName) &&
        Objects.equals(this.bankBranchName, bodyUpdateLoanDisbursementAccounts.bankBranchName) &&
        Objects.equals(this.ifscCode, bodyUpdateLoanDisbursementAccounts.ifscCode) &&
        Objects.equals(this.entityType, bodyUpdateLoanDisbursementAccounts.entityType) &&
        Objects.equals(this.accountNo, bodyUpdateLoanDisbursementAccounts.accountNo) &&
        Objects.equals(this.amount, bodyUpdateLoanDisbursementAccounts.amount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, accountType, bankName, bankAccountType, accountName, bankBranchName, ifscCode, entityType, accountNo, amount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BodyUpdateLoanDisbursementAccounts {\n");
