 ...
 */
@ApiModel(description = "Refer table DeviationDetails for attributes")
...
public class BodyCreateLoanDeviationDetails {
  ...
  public static final String SERIALIZED_NAME_MITIGANT = "mitigant";
  @SerializedName(SERIALIZED_NAME_MITIGANT)
  ...
  public BodyCreateLoanDeviationDetails summary(String summary) {
   ...
   /**
   * Summary details of the deviation being taken
   * @return summary
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Summary details of the deviation being taken")
  ...
  public BodyCreateLoanDeviationDetails desc(String desc) {
   ...
   /**
   * Description of the deviation requested
   * @return desc
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Description of the deviation requested")
  ...
  public BodyCreateLoanDeviationDetails mitigant(String mitigant) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Mitigant description")

  public String getMitigant() {
    return mitigant;
  }


  public void setMitigant(String mitigant) {
    this.mitigant = mitigant;
  }


  public BodyCreateLoanDeviationDetails level(String level) {
   ...
   /**
   * Severity of the deviation being requested
   * @return level
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Severity of the deviation being requested")
  ...
  public boolean equals(Object o) {
    ...
    BodyCreateLoanDeviationDetails bodyCreateLoanDeviationDetails = (BodyCreateLoanDeviationDetails) o;
    return Objects.equals(this.summary, bodyCreateLoanDeviationDetails.summary) &&
        Objects.equals(this.desc, bodyCreateLoanDeviationDetails.desc) &&
        Objects.equals(this.mitigant, bodyCreateLoanDeviationDetails.mitigant) &&
        Objects.equals(this.level, bodyCreateLoanDeviationDetails.level);
  }

  @Override
  public int hashCode() {
    return Objects.hash(summary, desc, mitigant, level);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BodyCreateLoanDeviationDetails {\n");
    sb.append("    summary: ").append(toIndentedString(summary)).append("\n");
    sb.append("    desc: ").append(toIndentedString(desc)).append("\n");
    sb.append("    mitigant: ").append(toIndentedString(mitigant)).append("\n");
