...
import org.openapitools.client.model.CreateRSSuccessRepaymentSchedules;
...
public class CreateRSSuccess {
  ...
  public static final String SERIALIZED_NAME_REPAYMENT_SCHEDULES = "repayment_schedules";
  @SerializedName(SERIALIZED_NAME_REPAYMENT_SCHEDULES)
  private List<CreateRSSuccessRepaymentSchedules> repaymentSchedules = null;


  public CreateRSSuccess clientLoanId(String clientLoanId) {
   ...
   /**
   * Client loan ID used during loan creation
   * @return clientLoanId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Client loan ID used during loan creation")
  ...
  public CreateRSSuccess repaymentSchedules(List<CreateRSSuccessRepaymentSchedules> repaymentSchedules) {
    
    this.repaymentSchedules = repaymentSchedules;
    return this;
  }

  public CreateRSSuccess addRepaymentSchedulesItem(CreateRSSuccessRepaymentSchedules repaymentSchedulesItem) {
    if (this.repaymentSchedules == null) {
      this.repaymentSchedules = new ArrayList<CreateRSSuccessRepaymentSchedules>();
    }
    this.repaymentSchedules.add(repaymentSchedulesItem);
    return this;
  }

   /**
   * Array of Repayment Schedules
   * @return repaymentSchedules
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array of Repayment Schedules")

  public List<CreateRSSuccessRepaymentSchedules> getRepaymentSchedules() {
    return repaymentSchedules;
  }


  public void setRepaymentSchedules(List<CreateRSSuccessRepaymentSchedules> repaymentSchedules) {
    this.repaymentSchedules = repaymentSchedules;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateRSSuccess createRSSuccess = (CreateRSSuccess) o;
    return Objects.equals(this.clientLoanId, createRSSuccess.clientLoanId) &&
        Objects.equals(this.repaymentSchedules, createRSSuccess.repaymentSchedules);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientLoanId, repaymentSchedules);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateRSSuccess {\n");
    sb.append("    clientLoanId: ").append(toIndentedString(clientLoanId)).append("\n");
    sb.append("    repaymentSchedules: ").append(toIndentedString(repaymentSchedules)).append("\n");
    sb.append("}");
    return sb.toString();
  }
